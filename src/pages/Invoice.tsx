      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <TabsList className="w-full md:w-auto">
            <TabsTrigger value="all" className="flex-1 md:flex-none">All Invoices</TabsTrigger>
            <TabsTrigger value="create" className="flex-1 md:flex-none">Create New</TabsTrigger>
          </TabsList>
        </div>
                  ...
                  <div className="max-h-[800px] overflow-auto">
                    {form.getValues("clientId") && (
                      <div className="p-6" id="invoice-preview">
                        <SelectedTemplate data={getPreviewData()!} />
                      </div>
                    )}
                  </div>
                </CardContent>
